...
const LoadingScreen: React.FC = () => {
  ...
  return (
    <div className="text-center p-8 mt-12 bg-black/20 rounded-xl border border-gray-800">
      ...
      <p className="text-lg text-gray-400 transition-opacity duration-500">{messages[messageIndex]}</p>
    </div>
  );
};
